            ...
            */
            else if (Z.HasBuilder("BasicLair"))
            {
                ...
                else if (Z.NewTier <= 6)
                {
                    ...
                    else if (Z.GetRegion() == "LakeHinnom")
                    {
                        Tracks =
                            new string[] {
                        ...
                        Z.GetRegion() == "BananaGrove" ||
                        Z.GetRegion() == "DeepJungle"
                    )
                    {
                        Tracks =
                            new string[] {
                ...
                else if (Z.NewTier == 7)
                {
                    ...
                    else if (Z.GetRegion() == "BaroqueRuins")
                    {
                        Tracks =
                            new string[] {
